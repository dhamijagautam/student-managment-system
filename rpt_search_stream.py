...
class Ui_rep_find_stream(object):
    def setupUi(self, rep_find_stream):
        rep_find_stream.setObjectName("rep_find_stream")
        rep_find_stream.resize(654, 561)
        self.label = QtWidgets.QLabel(rep_find_stream)
        ...
        self.label_2 = QtWidgets.QLabel(rep_find_stream)
        ...
        self.btn_search = QtWidgets.QPushButton(rep_find_stream)
        ...
        self.btn_next = QtWidgets.QPushButton(rep_find_stream)
        ...
        self.btn_export = QtWidgets.QPushButton(rep_find_stream)
        ...
        self.tbl_result = QtWidgets.QTableWidget(rep_find_stream)
        ...
        self.lbl_msg = QtWidgets.QLabel(rep_find_stream)
        ...
        self.cmb_stream = QtWidgets.QComboBox(rep_find_stream,activated=lambda : self.search())
        self.cmb_stream.setGeometry(QtCore.QRect(120, 101, 131, 41))
        self.cmb_stream.setObjectName("cmb_stream")

        self.retranslateUi(rep_find_stream)
        QtCore.QMetaObject.connectSlotsByName(rep_find_stream)
        self.btn_search.clicked.connect(self.search)
        self.btn_export.clicked.connect(self.export)


    def search(self):
        rn = self.cmb_stream.currentData()
        if rn == '' :
            self.lbl_msg.setText('Please select the stream')
        else:
            ...
            inner join streams using(stream_id) where stream_id='''+str(rn)
            print(sql)
            cur1.execute(sql)
    ...
    def retranslateUi(self, rep_find_stream):
        _translate = QtCore.QCoreApplication.translate
        rep_find_stream.setWindowTitle(_translate("rep_find_stream", "Find student by stream"))
        self.label.setText(_translate("rep_find_stream", "Find Student By Stream"))
        self.label_2.setText(_translate("rep_find_stream", "Stream"))
        self.btn_search.setText(_translate("rep_find_stream", "Search"))
        self.btn_next.setText(_translate("rep_find_stream", "Next"))
        self.btn_export.setText(_translate("rep_find_stream", "Export"))
        item = self.tbl_result.horizontalHeaderItem(0)
        item.setText(_translate("rep_find_stream", "Student_id"))
        item = self.tbl_result.horizontalHeaderItem(1)
        item.setText(_translate("rep_find_stream", "Name"))
        item = self.tbl_result.horizontalHeaderItem(2)
        item.setText(_translate("rep_find_stream", "Stream"))
        item = self.tbl_result.horizontalHeaderItem(3)
        item.setText(_translate("rep_find_stream", "Roll No."))
        item = self.tbl_result.horizontalHeaderItem(4)
        item.setText(_translate("rep_find_stream", "Phone NO"))
        self.lbl_msg.setText(_translate("rep_find_stream", "TextLabel"))
        self.show_streams()
...
if __name__ == "__main__":
    ...
    rep_find_stream = QtWidgets.QDialog()
    ui = Ui_rep_find_stream()
    ui.setupUi(rep_find_stream)
    rep_find_stream.show()
    sys.exit(app.exec_())
